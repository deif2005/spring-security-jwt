package com.security.jwt.service.impl.security.config;

import com.security.jwt.service.impl.security.filter.UsernamePasswordAuthenticationFilter;
import com.security.jwt.service.impl.security.handler.LoginAuthenticationFailureHandler;
...
public class JsonLoginConfigurer <T extends JsonLoginConfigurer<T, B>, B extends HttpSecurityBuilder<B>>
    ...
    public void configure(B http) throws Exception {
        ...
        //设置失败的Handler
        authFilter.setAuthenticationFailureHandler(new LoginAuthenticationFailureHandler());
